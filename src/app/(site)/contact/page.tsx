...
export const metadata: Metadata = {
  title: "Контакты — Kapriz Travel",
  description: "Свяжитесь с нами через WhatsApp, Telegram или Instagram. г. Бишкек, Кыргызстан.",
};
      ...
      <div className="bg-blue-gradient py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 mt-4 text-base">
            Ответим на все вопросы в рабочее время. Обычно отвечаем в течение часа.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <h2 className="font-heading font-800 text-gray-900 uppercase text-2xl">
              Как связаться
            </h2>
            ...
            {[
              ...
              <a
                ...
                className="flex items-center gap-4 p-5 border border-gray-100 rounded-2xl hover:border-brand-blue hover:shadow-md transition-all duration-200 cursor-pointer group"
              >
                <div className={`w-12 h-12 ${c.bg} rounded-xl flex items-center justify-center text-white shrink-0`}>
                  {c.icon}
                </div>
                <div>
                  <div className="font-heading font-800 text-gray-900 text-base group-hover:text-brand-blue transition-colors duration-200">
                    {c.label}
                  </div>
                  <div className="text-gray-500 text-sm">{c.value}</div>
                </div>
                <svg className="w-5 h-5 text-gray-300 ml-auto group-hover:text-brand-blue transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
