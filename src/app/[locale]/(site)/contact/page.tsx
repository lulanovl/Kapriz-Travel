    ...
    <div className="bg-white">
      ...
      <div className="bg-blue-gradient py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 mt-4 text-base">{t("sub")}</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            {contacts.map((c) => (
              ...
              >
                <div
                  className={`w-12 h-12 ${c.bg} rounded-xl flex items-center justify-center text-white shrink-0`}
                >
                  {c.icon}
                </div>
                <div>
                ...
                <svg
                  className="w-5 h-5 text-gray-300 ml-auto group-hover:text-brand-blue transition-colors duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-500 text-sm mt-0.5">{t("addressLine1")}</div>
                <div className="text-gray-500 text-sm">{t("addressLine2")}</div>
                <div className="text-gray-400 text-xs mt-1">{t("hours")}</div>
              </div>
            </a>
          </div>
