...
import { getLocalizedTour } from "@/lib/tourLocale";
...
export async function generateMetadata({
  ...
  return {
    title: loc.seoTitle ?? `${loc.title} — Kapriz Travel`,
    description: loc.seoDescription ?? loc.description?.slice(0, 160) ?? "",
  };
}
...
export default async function TourPage({
  ...
  const included = Array.isArray(loc.included) ? (loc.included as string[]) : [];
  const notIncluded = Array.isArray(loc.notIncluded)
    ? (loc.notIncluded as string[])
    : [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {/* Itinerary */}
            <ItineraryView itinerary={loc.itinerary} title={loc.title} />
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-blue-gradient rounded-2xl p-6 text-white">
                ...
                <div className="font-heading font-900 text-4xl text-brand-lime mt-1">
                  ...
                  <span className="text-xl font-600 text-white/70 ml-1">
                    {t("priceUnit")}
                  </span>
                </div>
