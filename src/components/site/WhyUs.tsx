const reasons = [
  {
    ...
    title: "Надёжность",
    text: "6 лет на рынке, более 2500 довольных туристов. Лицензированный туроператор Кыргызстана.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Опытные гиды",
    text: "Профессиональные гиды с глубоким знанием регионов и историей Центральной Азии.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Честные цены",
    text: "Никаких скрытых доплат. Всё включено в стоимость тура — трансфер, гид, питание по программе.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    text: "На связи через WhatsApp и Telegram. Ответим на любые вопросы до, во время и после тура.",
  },
];
